    ...
    <main class="full-box main-container">
        ...
        <section class="full-box page-content">
            ...
            <div class="full-box page-header">
                <h3 class="text-left">
                    <i class="fas fa-plus fa-fw"></i> &nbsp; AGREGAR EDITORIAL
                </h3>
                <p class="text-justify">
                ¡Siempre es bienvenida una nueva editorial!
                </p>
            </div>
            ...
            <div class="container-fluid">
                <ul class="full-box list-unstyled page-nav-tabs">
                    <li>
                        <a class="active" href="<?= BASE_URL ?>agregarEditorial"><i class="fas fa-plus fa-fw"></i> &nbsp; AGREGAR EDITORIAL</a>
                    </li>
                    <li>
            ...
            <!-- Content here-->
            <div class="container-fluid">
                <form action="<?= BASE_URL ?>agregarEditorial/creaEditorial" class="form-neon" autocomplete="off" method="get">
                    <fieldset>
